...
const Sidebar = () => {
  ...
  return (
    <div className="mb-10 hidden large:block px-4">
      ...
      <ul>
        <a
          onClick={hiddenShow1}
          href=""
          className="w-48 laptop:w-60 pb-2 border-b border-gray-200 flex flex-col justify-between"
        >
          <span className="w-48 laptop:w-60 flex justify-between">
        ...
        <a
          onClick={hiddenShow2}
          href=""
          className="flex w-48 laptop:w-60 flex-col justify-between border-b-[1px] pb-[2px] border-slate-200 "
        >
          <span className="w-48 laptop:w-60 flex justify-between">
        ...
        <a
          href=""
          className="flex w-48 laptop:w-60 justify-between border-b-[1px] pb-[2px] border-slate-200 "
        >
